# Octopus Workshop Sample Repository
...
This code is not intended for production use. It exists solely to support the workshop exercises and keep the focus on Octopus workflows rather than application complexity.
